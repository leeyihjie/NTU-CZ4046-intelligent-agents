import part_2.value_iteration as VI
import part_2.policy_iteration as PI

# Rename to main to run and other to another name. This main is for Task 2.
# Press the green button in the gutter to run the script.
if __name__ == '__main__':
    while True:
        try:
            choice = int(input("Part 2! Input 1 for Value Iteration or 2 for Policy Iteration: "))
        except ValueError:
